        ...
        <table height="350" align="center" width="700">
          <tr bgcolor="#CC3300"> 
            <td width="610" bgcolor="#FBF7E1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="#336633" size="+1" face="Georgia, Times New Roman, Times, serif"><img src="images/key.png" width="35" height="35" />&nbsp;Payment Staff 
              Signup</font></strong> <br> <form name="s" action="bill_signup1.jsp" method="get" onsubmit="return valid()">
